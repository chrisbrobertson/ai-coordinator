...
export async function detectTools(env = process.env) {
...
export function getDefaultLeadOrder() {
    return ['claude', 'codex', 'gemini'];
}
async function resolveOnPath(command, env) {
...
async function detectVersion(command, env) {
    try {
